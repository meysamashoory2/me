...
class MenuAndHistoryTests(TestCase):
    ...
    def test_sidebar_labels_and_history_route(self):
        ...
        self.assertContains(dash, "مدیریت داده‌ها")
        self.assertContains(dash, reverse("system_data"))
        self.assertContains(dash, "برنامه‌ریزی هوشمند")
        self.assertContains(dash, "محاسبات تولید")
        self.assertContains(dash, "کاربری سامانه")
        self.assertContains(dash, "پیکربندی سیستم")
        ...
        self.assertContains(system, "عناوین و ساختار نمایش")
        self.assertContains(system, "پیکربندی منوها")
        self.assertContains(system, "پشتیبان‌گیری و بازیابی")
        ...
        self.assertContains(system, "کادرآبی")
        ...
        self.assertContains(molds, "مدیریت داده‌ها")
        self.assertContains(molds, "admin-embed")
        self.assertContains(molds, "بازگشت به مدیریت داده‌ها")
        ...
        self.assertContains(groups_admin, "بازگشت به مدیریت داده‌ها")
