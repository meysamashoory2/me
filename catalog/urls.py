...
urlpatterns = [
    ...
    path("data/system/menu-config/", views.system_menu_config, name="system_menu_config"),
    path("data/system/planning-chrome/", views.system_planning_chrome, name="system_planning_chrome"),
