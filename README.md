...
- **پشتیبان‌گیری و بازیابی تفکیکی** برای مدیر برنامه‌ریزی: پشتیبان کامل یا انتخاب بخش‌ها،
  ذخیره در آدرس دلخواه روی سرور، و بازیابی از همان آدرس یا پرونده zip
  (منوی «کاربری سامانه» ← «پشتیبان‌گیری»).
